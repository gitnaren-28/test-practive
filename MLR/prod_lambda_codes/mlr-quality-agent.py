...
MLR_QUALITY_AGENT_RUNTIME_ARN = get_parameter_value("MLR_QUALITY_AGENT_RUNTIME_ARN")
...
def lambda_handler(event, context):
    try:
        ...
        kwargs = {
            "agentRuntimeArn": MLR_QUALITY_AGENT_RUNTIME_ARN,
        ...
        response.update({"finding_type": "quality_agent"})
        return response
    except Exception as e:
        raise Exception(f"quality agent invocation failed: {e}")